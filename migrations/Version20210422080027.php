 ...
 */
final class Version20210422080027 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE im2021_panier (quantite INTEGER NOT NULL, User_id INTEGER NOT NULL, Produit_Id INTEGER NOT NULL, PRIMARY KEY(User_id), CONSTRAINT FK_2129058F68D3EA09 FOREIGN KEY (User_id) REFERENCES im2021_user (pk) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_2129058FD5ED5989 FOREIGN KEY (Produit_Id) REFERENCES im2021_produit (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
